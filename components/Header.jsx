    ...
    >
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          {/* Icon Start  */}
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-s-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
          ...
          {/* Mobile icon start */}
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-s-full flex md:hidden justify-center items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2">
            {mobileMenu ? (
              <VscChromeClose
                className="text-[16px]"
