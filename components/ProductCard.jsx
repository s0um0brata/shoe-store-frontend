...
import { discountedPricePercentage } from '@/utils/helper'
      ...
      <div className='p-4 text-black/[0.9]'>
        ...
        <div className='flex items-center text-black/[0.5]'>
            ...
            {p.original_price && (
              ...
              <p className='ml-auto text-base font-medium text-green-500'>{discountedPricePercentage(p.original_price, p.price)}% off</p>
              </>
            )}
